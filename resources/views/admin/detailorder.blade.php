...
@section('content')
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
        $grandTotalPayable = $order->reserved ? max(0, $grandTotalDb - $dp) : $grandTotalDb;
    @endphp
            ...
            <div class="card-body">
                @if ($order->payment_status != 'paid')
                    <form action="{{ route('kasir.orders.pay', $order) }}" method="POST" class="row g-2">
                        @csrf
                        <input type="hidden" name="is_reserved" value="{{ $order->table?->status ?? '-' }}">
                        <div class="col-md-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="text" class="form-control" value="{{ rupiah($grandTotalPayable) }}" disabled>

                            <input type="hidden" name="paid_amount" value="{{ $grandTotalPayable }}">
                        </div>
                        ...
                        <div class="col-md-2 d-flex align-items-end">
                            <a href="{{ route('kasir.orders.print', $order) }}" target="_blank" class="btn btn-primary">
                                Cetak Struk
                            </a>
                        </div>
