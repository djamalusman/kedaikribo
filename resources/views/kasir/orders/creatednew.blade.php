...
@section('content')
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content error-modal">
                        ...
                        <div class="modal-body text-center">
                            <h3 class="fw-bold mb-2">Ooops!</h3>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            on(form, 'submit', function(e) {
                ...
                if (isReserved && (!tableSelect || !tableSelect.value)) {
                    e.preventDefault();
                    showErrorModal('Jika Reserved, silakan pilih meja.');
                    return;
                }

                if (isReserved && (!dpInput || !dpInput.value)) {
                    e.preventDefault();
                    showErrorModal('Nominal DP wajib diisi.');
                    return;
                }
                ...
                if (isReserved) {
                    if (!startDateInput.value) {
                        e.preventDefault();
                        showErrorModal('Start Date wajib diisi.');
                        return;
                    }

                    if (!endDateInput.value) {
                        e.preventDefault();
                        showErrorModal('End Date wajib diisi.');
                        return;
                    }

                    if (new Date(endDateInput.value) <= new Date(startDateInput.value)) {
                        e.preventDefault();
                        showErrorModal('End Date harus lebih besar dari Start Date.');
                        return;
                    }
                }
    ...
    <script>
        ...
        // ✅ yang perlu DOM siap itu event & selector
