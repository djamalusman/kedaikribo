                        ...
                        <div class="row g-2">
                            @forelse($cat->menuItems as $menu)
                                <div class="col-6 col-md-4">
                                    <button type="button"
                                            class="btn btn-outline-secondary w-100 text-start add-to-cart-btn"
                                            data-id="{{ $menu->id }}"
                                            data-name="{{ $menu->name }}"
...
<script>
    ...
    // Data awal cart dari server (order_items existing)
    let cart = @json(
    ...
    // setelah ini, panggil fungsi renderCart() yang sudah kamu buat
