...
use App\Exports\OrdersFullReportExport;
...
class AdminDashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        $menuDetailMap = [];
            ...
            // $odersDetail = Order::with(['items.menuItem','customer', 'table','payments','promotion','reserved','outlet'])
    ...
    public function exportExcel(Request $request)
    {
        ...
        return Excel::download(
            new OrdersFullReportExport($orders),
            'LAPORAN_ORDERS_'.$request->start_date.'_SD_'.$request->end_date.'.xlsx'
        );
    }
